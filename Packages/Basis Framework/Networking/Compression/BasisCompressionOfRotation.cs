...
namespace Basis.Scripts.Networking.Compression
{
    public static class BasisCompressionOfRotation
    {
        ...
        {
            Packer.Write(QuaternionCompressor.CompressQuaternion(ref Rotation));//BasisCompression.CompressQuaternion(Rotation)
        }
        public static void DecompressQuaternion(DarkRiftReader bitPacker, ref Quaternion Quaternion)
        {
            //checked
            bitPacker.Read(out uint data);
            QuaternionCompressor.DecompressQuaternion(ref Quaternion, data);
        }
        /// <summary>
