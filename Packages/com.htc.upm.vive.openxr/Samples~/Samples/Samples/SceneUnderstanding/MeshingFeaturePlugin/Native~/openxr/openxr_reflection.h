...
#define XR_LIST_ENUM_XrStructureType(_) \
    ...
    _(XR_TYPE_SYSTEM_EXPRESSION_PROPERTIES_HTC, 1000104000) \
    _(XR_TYPE_EXPRESSION_CREATE_INFO_HTC, 1000104001) \
    _(XR_TYPE_EXPRESSION_DATA_HTC, 1000104002) \
...
#define XR_LIST_ENUM_XrObjectType(_) \
    ...
    _(XR_OBJECT_TYPE_EXPRESSION_HTC, 1000104000) \
...
#define XR_LIST_ENUM_XrEyeShapeHTC(_) \
    _(XR_EYE_SHAPE_NONE_HTC, -1) \
    _(XR_EYE_SHAPE_EYE_LEFT_BLINK_HTC, 0) \
    _(XR_EYE_SHAPE_EYE_LEFT_WIDE_HTC, 1) \
    _(XR_EYE_SHAPE_EYE_RIGHT_BLINK_HTC, 2) \
    _(XR_EYE_SHAPE_EYE_RIGHT_WIDE_HTC, 3) \
    _(XR_EYE_SHAPE_EYE_LEFT_SQUEEZE_HTC, 4) \
    _(XR_EYE_SHAPE_EYE_RIGHT_SQUEEZE_HTC, 5) \
    _(XR_EYE_SHAPE_MAX_ENUM_HTC, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrLipShapeHTC(_) \
    _(XR_LIP_SHAPE_NONE_HTC, -1) \
    _(XR_LIP_SHAPE_JAW_RIGHT_HTC, 0) \
    _(XR_LIP_SHAPE_JAW_LEFT_HTC, 1) \
    _(XR_LIP_SHAPE_JAW_FORWARD_HTC, 2) \
    _(XR_LIP_SHAPE_JAW_OPEN_HTC, 3) \
    _(XR_LIP_SHAPE_MOUTH_APE_SHAPE_HTC, 4) \
    _(XR_LIP_SHAPE_MOUTH_UPPER_RIGHT_HTC, 5) \
    _(XR_LIP_SHAPE_MOUTH_UPPER_LEFT_HTC, 6) \
    _(XR_LIP_SHAPE_MOUTH_LOWER_RIGHT_HTC, 7) \
    _(XR_LIP_SHAPE_MOUTH_LOWER_LEFT_HTC, 8) \
    _(XR_LIP_SHAPE_MOUTH_UPPER_OVERTURN_HTC, 9) \
    _(XR_LIP_SHAPE_MOUTH_LOWER_OVERTURN_HTC, 10) \
    _(XR_LIP_SHAPE_MOUTH_POUT_HTC, 11) \
    _(XR_LIP_SHAPE_MOUTH_SMILE_RIGHT_HTC, 12) \
    _(XR_LIP_SHAPE_MOUTH_SMILE_LEFT_HTC, 13) \
    _(XR_LIP_SHAPE_MOUTH_SAD_RIGHT_HTC, 14) \
    _(XR_LIP_SHAPE_MOUTH_SAD_LEFT_HTC, 15) \
    _(XR_LIP_SHAPE_CHEEK_PUFF_RIGHT_HTC, 16) \
    _(XR_LIP_SHAPE_CHEEK_PUFF_LEFT_HTC, 17) \
    _(XR_LIP_SHAPE_CHEEK_SUCK_HTC, 18) \
    _(XR_LIP_SHAPE_MOUTH_UPPER_UPRIGHT_HTC, 19) \
    _(XR_LIP_SHAPE_MOUTH_UPPER_UPLEFT_HTC, 20) \
    _(XR_LIP_SHAPE_MOUTH_LOWER_DOWNRIGHT_HTC, 21) \
    _(XR_LIP_SHAPE_MOUTH_LOWER_DOWNLEFT_HTC, 22) \
    _(XR_LIP_SHAPE_MOUTH_UPPER_INSIDE_HTC, 23) \
    _(XR_LIP_SHAPE_MOUTH_LOWER_INSIDE_HTC, 24) \
    _(XR_LIP_SHAPE_MOUTH_LOWER_OVERLAY_HTC, 25) \
    _(XR_LIP_SHAPE_TONGUE_LONGSTEP1_HTC, 26) \
    _(XR_LIP_SHAPE_TONGUE_LEFT_HTC, 27) \
    _(XR_LIP_SHAPE_TONGUE_RIGHT_HTC, 28) \
    _(XR_LIP_SHAPE_TONGUE_UP_HTC, 29) \
    _(XR_LIP_SHAPE_TONGUE_DOWN_HTC, 30) \
    _(XR_LIP_SHAPE_TONGUE_ROLL_HTC, 31) \
    _(XR_LIP_SHAPE_TONGUE_LONGSTEP2_HTC, 32) \
    _(XR_LIP_SHAPE_TONGUE_UPRIGHT_MORPH_HTC, 33) \
    _(XR_LIP_SHAPE_TONGUE_UPLEFT_MORPH_HTC, 34) \
    _(XR_LIP_SHAPE_TONGUE_DOWNRIGHT_MORPH_HTC, 35) \
    _(XR_LIP_SHAPE_TONGUE_DOWNLEFT_MORPH_HTC, 36) \
    _(XR_LIP_SHAPE_MAX_ENUM_HTC, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrExpressionTypeHTC(_) \
    _(XR_EXPRESSION_TYPE_EYE_HTC, 1) \
    _(XR_EXPRESSION_TYPE_LIP_HTC, 2) \
    _(XR_EXPRESSION_TYPE_MAX_ENUM_HTC, 0x7FFFFFFF)
...
#define XR_LIST_STRUCT_XrSystemExpressionPropertiesHTC(_) \
    _(type) \
    _(next) \
    _(supportEyeExpression) \
    _(supportLipExpression) \
    _(maxBlendShapesCount) \

#define XR_LIST_STRUCT_XrExpressionDataHTC(_) \
    _(type) \
    _(next) \
    _(sampleTime) \
    _(blendShapesCapacityInput) \
    _(blendShapesCountOutput) \
    _(blendShapeWeightings) \

#define XR_LIST_STRUCT_XrExpressionCreateInfoHTC(_) \
    _(type) \
    _(next) \
    _(expressionType) \
...
#define XR_LIST_STRUCTURE_TYPES_CORE(_) \
    ...
    _(XrSystemExpressionPropertiesHTC, XR_TYPE_SYSTEM_EXPRESSION_PROPERTIES_HTC) \
    _(XrExpressionDataHTC, XR_TYPE_EXPRESSION_DATA_HTC) \
    _(XrExpressionCreateInfoHTC, XR_TYPE_EXPRESSION_CREATE_INFO_HTC) \
...
#define XR_LIST_EXTENSIONS(_) \
    ...
    _(XR_HTC_facial_expression, 105) \
